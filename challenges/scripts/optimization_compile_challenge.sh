#!/usr/bin/env bash
# optimization_compile_challenge.sh - Validates Optimization module compilation and code quality
set -euo pipefail
...
echo "Test: Module name is digital.vasic.optimization"
if grep -q "^module digital.vasic.optimization$" "${MODULE_DIR}/go.mod"; then
    pass "Module name is digital.vasic.optimization"
else
