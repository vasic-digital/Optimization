# Optimization - Generic, reusable LLM optimization module for Go applications.
...
challenge:
	../challenges/scripts/optimization_challenge.sh 2>/dev/null || echo "No challenge script"

help:
	@echo "Optimization - Generic, reusable LLM optimization module for Go applications."
	@echo ""
	@echo "Build & Test:"
